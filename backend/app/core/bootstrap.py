...
Quy tac:
  ...
  - Neu username trung voi tai khoan da ton tai -> nang cap tai khoan do
    (`is_system = True`, `role = "admin"`, `is_active = True`).
...
STANDARD_UNITS = [
    ("Ban chỉ huy Lữ đoàn", "bch_lu_doan", "Lữ trưởng, Chính uỷ, các Phó Lữ trưởng, Phó Chính uỷ"),
    ("Cấp uỷ – Đảng bộ Lữ đoàn", "cap_uy", "Cấp uỷ, Đảng bộ Lữ đoàn"),
    ("Phòng Tham mưu", "phong_ban",
     "Cơ quan tham mưu — đầu mối nhận và triển khai nhiệm vụ tác chiến, huấn luyện, SSCĐ"),
    ("Phòng Chính trị", "phong_ban",
     "Cơ quan chính trị — đầu mối công tác đảng, công tác chính trị, tuyên huấn"),
    ("Phòng Hậu cần – Kỹ thuật", "phong_ban",
     "Cơ quan hậu cần – kỹ thuật — đầu mối bảo đảm vật chất, kỹ thuật, quân y"),
    ("Tiểu đoàn 1", "tieu_doan", "Đầu mối tiểu đoàn — nhận nhiệm vụ và báo cáo tiến độ"),
    ("Tiểu đoàn 2", "tieu_doan", "Đầu mối tiểu đoàn — nhận nhiệm vụ và báo cáo tiến độ"),
    ("Đại đội 5", "dai_doi", "Đầu mối đại đội trực thuộc"),
    ("Trạm bảo đảm", "tram", "Trạm bảo đảm thông tin"),
    ("Trung tâm 2", "phong_ban", "Trung tâm 2 — đầu mối trực thuộc"),
]
